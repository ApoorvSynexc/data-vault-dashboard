...
export function useUserService() {
  ...
  return {
    ...
    updateProfile: async <TResponse>(payload: UpdateProfilePayload) => (await api.put<TResponse>('/v1/user/my-profile', payload)).data,
    ...
    deleteMyProfile: async <TResponse>() => (await api.delete<TResponse>('/v1/user/my-profile')).data,
  };
}
