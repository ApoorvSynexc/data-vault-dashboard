...
export function useBackupConfigService() {
  ...
  return {
    ...
    getObjectRecords: (payload: { crmId: string; apiName: string; fields: string[]; whereClause?: string; objectConfig?: Record<string, unknown>; referenceName?: string; parent?: Record<string, unknown> }) =>
