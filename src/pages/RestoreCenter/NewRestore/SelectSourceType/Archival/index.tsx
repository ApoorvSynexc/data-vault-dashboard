...
export default function ArchivalPicker({ onConfigSelected, onSelectionChange, initialSelectedConfigId = '', onSelectedRowChange, onSelectedConfigIdChange }: Props) {
  ...
  const selectRow = (row: any) => {
    ...
    onSelectionChange({ backupConfigId: row.backupConfigId, slug: row.slug ?? row.backupConfigId, backupJobIds: [] });
