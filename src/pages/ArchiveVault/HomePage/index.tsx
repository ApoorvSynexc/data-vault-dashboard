    ...
    <div className='flex-1 min-h-0 bg-gray-50 flex flex-col overflow-hidden'>
      ...
      <div className='rounded-xl border border-gray-200 bg-white px-4 py-3 shadow-sm'>
        ...
        <div className='grid grid-cols-4 gap-3'>
          ...
          />
          <MetricCard loading={isLoading} label='Completed archives Jobs' value={stats?.completedArchival != null ? pad(stats.completedArchival) : '--'}
        ...
        {(() => {
          ...
          return (
            <Table<EnrichedPolicy>
              ...
              cursorMode={true}
              hidePaginationSummary={!!debouncedSearch || statusFilter !== 'All' || lastJobFilter !== 'All'}
              pagination={{
                currentPage: 1,
