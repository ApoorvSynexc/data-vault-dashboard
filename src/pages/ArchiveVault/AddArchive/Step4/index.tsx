              ...
              <div className='flex items-center gap-2 min-w-0'>
                <div className='flex-shrink-0 flex items-center justify-center rounded-full'
                  ...
                  {isDone
                    ...
                    : <svg width='16' height='16' viewBox='0 0 24 24' fill='none' stroke={isActive ? '#fff' : '#62748E'} strokeWidth='1.8' strokeLinecap='round' strokeLinejoin='round'>
                        {step.id === 1 && <><polyline points='21 8 21 21 3 21 3 8' /><rect x='1' y='3' width='22' height='5' /><line x1='10' y1='12' x2='14' y2='12' /></>}
                        {step.id === 2 && <><rect x='3' y='3' width='18' height='18' rx='2' /><line x1='3' y1='9' x2='21' y2='9' /><line x1='9' y1='21' x2='9' y2='9' /></>}
                        {step.id === 3 && <polygon points='22 3 2 3 10 12.46 10 19 14 21 14 12.46 22 3' />}
                        {step.id === 4 && <><rect x='3' y='4' width='18' height='18' rx='2' /><line x1='16' y1='2' x2='16' y2='6' /><line x1='8' y1='2' x2='8' y2='6' /><line x1='3' y1='10' x2='21' y2='10' /></>}
                        {step.id === 5 && <><path d='M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z' /><polyline points='14 2 14 8 20 8' /></>}
                      </svg>
                  }
                </div>
